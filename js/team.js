...
const MEMBERS_DATA = [
    ...
    // 学生团队成员 
    { id: '4', name: 'Zhenyayuan Cao', role: 'Team Member', programme: 'Biopharmaceuticals', group: 'Wet Team', quote: 'Science communication matters.', emoji: '🔬' },
    { id: '5', name: 'Jiaqi Zheng', role: 'Team Member', programme: 'Artificial Intelligence', group: 'Web Team', quote: 'Coding DNA one byte at a time.', emoji: '💻' },
    { id: '6', name: 'Yinren Zhao', role: 'Team Member', programme: 'Biological Science', group: 'Wet Team', quote: 'Precision in science.', emoji: '🔬' },
    { id: '7', name: 'Jiaxing Ye', role: 'Team Member', programme: 'Bioinformatics', group: 'Wet Team', quote: 'Discovery through diligence.', emoji: '🔬' },
    { id: '8', name: 'Keyi Zhao', role: 'Team Member', programme: 'Bioinformatics', group: 'Web Team', quote: 'Making science beautiful.', emoji: '🎨' },
    { id: '9', name: 'Shunran Wang', role: 'Team Member', programme: 'Bioinformatics', group: 'HP Team', quote: 'Building bridges in science.', emoji: '🤝' },
    { id: '10', name: 'Ziyun Shi', role: 'Team Member', programme: 'Biological Science', group: 'HP Team', quote: 'Sharing scientific knowledge.', emoji: '🤝' },
    { id: '11', name: 'Yuehan Hu', role: 'Team Member', programme: 'Bioinformatics', group: 'HP Team', quote: 'Public engagement in science.', emoji: '🤝' },
    { id: '12', name: 'Ruizhong Shu', role: 'Team Member', programme: 'Biological Science', group: 'Wet Team', quote: 'Dedicated to research excellence.', emoji: '🔬' },
    { id: '13', name: 'Ge Gao', role: 'Team Member', programme: 'Pharmaceutical Sciences', group: 'Wet Team', quote: 'Precision and passion in research.', emoji: '🔬' },
    { id: '14', name: 'Yue Yu', role: 'Team Member', programme: 'Bioinformatics', group: 'Modeling Team', quote: 'Data-driven discovery.', emoji: '📊' },
    { id: '15', name: 'Siqi Liu', role: 'Team Member', programme: 'Bioinformatics', group: 'Modeling Team', quote: 'Simulating biological systems.', emoji: '📊' },
    { id: '16', name: 'Jiaying Gu', role: 'Team Member', programme: 'Biological Science', group: 'Wet Team', quote: 'Innovation in the lab.', emoji: '🔬' },
    { id: '17', name: 'Yiming Huang', role: 'Team Member', programme: 'Bioinformatics', group: 'Modeling Team', quote: 'Simulating the future.', emoji: '📊' },
    { id: '18', name: 'Ziming Sang', role: 'Team Member', programme: 'UG-1', group: 'Modeling Team', quote: 'Analyzing tRNA abundance and codon usage patterns.', emoji: '📊' },
    { id: '19', name: 'Fangying Xiang', role: 'Team Member', programme: 'UG-1', group: 'Wet Team', quote: 'One micropipette at a time.', emoji: '🔬' },
    { id: '20', name: 'Tianle Yang', role: 'Team Member', programme: 'UG-1', group: 'HP Team', quote: 'Engagement through education.', emoji: '🤝' },
    { id: '21', name: 'Ruoxuan Chen', role: 'Team Member', programme: 'UG-1', group: 'HP Team', quote: 'Connecting science with society.', emoji: '🤝' },
    ...
    // Advisors
    { id: '36', name: 'Lanlan Han', role: 'Advisor', programme: 'Department of Biosciences and Bioinformatics', group: 'Advisors', quote: 'Guiding discovery.', emoji: '👨‍🏫' },
    { id: '37', name: 'Shuhua Wang', role: 'Advisor', programme: 'Department of Biosciences and Bioinformatics', group: 'Advisors', quote: 'Guiding discovery.', emoji: '👨‍🏫' },
    { id: '38', name: 'Weiwei Dai', role: 'Advisor', programme: 'Department of Biosciences and Bioinformatics', group: 'Advisors', quote: 'Guiding discovery.', emoji: '👨‍🏫' },
    { id: '39', name: 'Yong Shen', role: 'Advisor', programme: 'Department of Biosciences and Bioinformatics', group: 'Advisors', quote: 'Guiding discovery.', emoji: '👨‍🏫' },
    { id: '40', name: 'Kam Antony', role: 'Advisor', programme: 'Department of Biosciences and Bioinformatics', group: 'Advisors', quote: 'Guiding discovery.', emoji: '👨‍🏫' },
    { id: '41', name: 'Leewei Lim', role: 'Advisor', programme: 'Department of Biosciences and Bioinformatics', group: 'Advisors', quote: 'Guiding discovery.', emoji: '👨‍🏫' },
    { id: '22', name: 'Chenxi Xu', role: 'Advisor', programme: 'Applied Mathematics', group: 'Advisors', quote: 'Supporting student research.', quote: 'Guiding discovery.', emoji: '👨‍🏫' },
    { id: '23', name: 'Rui Chen', role: 'Advisor', programme: 'Biomedical Sciences', group: 'Advisors', quote: 'Guiding experimental design.', quote: 'Guiding discovery.', emoji: '👨‍🏫' },
    { id: '24', name: 'Jie Zhong', role: 'Advisor', programme: 'Biological Science', group: 'Advisors', quote: 'Mentoring young scientists.', quote: 'Guiding discovery.', emoji: '👨‍🏫' },
    { id: '25', name: 'Shuning Dong', role: 'Advisor', programme: 'Biological Science', group: 'Advisors', quote: 'Providing technical guidance.', quote: 'Guiding discovery.', emoji: '👨‍🏫' },
    { id: '26', name: 'Jimin Hong', role: 'Advisor', programme: 'Pharmaceutical Sciences', group: 'Advisors', quote: 'Expert in pharmaceutical sciences.', quote: 'Guiding discovery.', emoji: '👨‍🏫' },
    { id: '27', name: 'Hanming Hu', role: 'Advisor', programme: 'Biopharmaceuticals', group: 'Advisors', quote: 'Biopharmaceutical expertise.', quote: 'Guiding discovery.', emoji: '👨‍🏫' },
    { id: '28', name: 'Zhicheng Yang', role: 'Advisor', programme: 'Bioinformatics', group: 'Advisors', quote: 'Bioinformatics support.', quote: 'Guiding discovery.', emoji: '👨‍🏫' },
    { id: '29', name: 'Shulei He', role: 'Advisor', programme: 'Biological Science', group: 'Advisors', quote: 'Biological research guidance.', quote: 'Guiding discovery.', emoji: '👨‍🏫' },
    { id: '30', name: 'Yifan Hou', role: 'Advisor', programme: 'Biopharmaceuticals', group: 'Advisors', quote: 'Biopharmaceutical knowledge sharing.', quote: 'Guiding discovery.', emoji: '👨‍🏫' },
    { id: '31', name: 'Tianran Chen', role: 'Advisor', programme: 'Biopharmaceuticals', group: 'Advisors', quote: 'Supporting experimental work.', quote: 'Guiding discovery.', emoji: '👨‍🏫' },
    { id: '32', name: 'Yaqi Zhang', role: 'Advisor', programme: 'Biological Science', group: 'Advisors', quote: 'Mentoring biological research.', quote: 'Guiding discovery.', emoji: '👨‍🏫' },
];
